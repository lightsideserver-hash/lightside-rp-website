...
export const Features = () => {
  ...
  useGSAP(() => {
    // Cím animáció (scrub nélkül a tisztább hatásért)
  ...
  return (
    <section
      ref={containerRef}
      id="features"
      className="section-padding bg-gradient-to-b from-gta-black to-gta-graphite"
    >
      <div className="container-gta">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gta-light max-w-2xl mx-auto">
            Minden, amire szükséged van a tökéletes roleplay élményhez
          </p>
        </div>
